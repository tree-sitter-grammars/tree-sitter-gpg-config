LANGUAGE_NAME := tree-sitter-gpg
HOMEPAGE_URL := https://github.com/tree-sitter-grammars/tree-sitter-gpg-config
VERSION := 0.3.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/gpg '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/gpg
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/gpg
