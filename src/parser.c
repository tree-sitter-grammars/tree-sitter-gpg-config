...
static const char * const ts_symbol_names[] = {
  ...
  [anon_sym_COMMA] = ",",
  [sym__list_parameter] = "parameter",
  [anon_sym_verify_DASHoptions] = "verify-options",
  [sym__verify_parameter] = "parameter",
  ...
  [sym__keyid_format_value] = "parameter",
  ...
  [sym__tofu_policy_value] = "parameter",
  ...
  [sym__key_origin_value] = "parameter",
  [anon_sym_import_DASHoptions] = "import-options",
  [sym__import_parameter] = "parameter",
  [anon_sym_export_DASHoptions] = "export-options",
  [sym__export_parameter] = "parameter",
  ...
  [sym__compliance_value] = "parameter",
  ...
  [sym__debug_level_value] = "parameter",
  [anon_sym_debug] = "debug",
  [aux_sym__debug_token1] = "number",
  [sym__debug_flag_value] = "parameter",
  ...
  [sym__pinentry_mode_value] = "parameter",
  [anon_sym_request_DASHorigin] = "request-origin",
  [sym__request_origin_value] = "parameter",
  ...
  [sym__default_preference_value] = "parameter",
