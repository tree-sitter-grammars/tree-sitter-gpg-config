...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '\'') ADVANCE(3162);
      if (lookahead == ',') ADVANCE(3165);
      if (lookahead == '2') ADVANCE(3170);
      if (lookahead == '=') ADVANCE(3158);
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(3172);
      if (('0' <= lookahead && lookahead <= '3')) ADVANCE(3170);
      if (lookahead != 0) ADVANCE(3170);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(3035);
      END_STATE();
    case 2:
      ...
      if (lookahead == '%') ADVANCE(3171);
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(3461);
      if (lookahead != 0) ADVANCE(3170);
      END_STATE();
    case 3:
      if (lookahead == '\n') ADVANCE(3035);
      if (lookahead == '\r') ADVANCE(3342);
      if (lookahead == '%') ADVANCE(3343);
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(3461);
      if (lookahead != 0 &&
          lookahead != '=') ADVANCE(3341);
      END_STATE();
    case 4:
      if (lookahead == '!') ADVANCE(3331);
      if (lookahead == '%') ADVANCE(3343);
    ...
    case 5:
      ...
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2282);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2321);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2796);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(2542);
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2677);
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2638);
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2423);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2414);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2761);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2298);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2415);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2451);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2823);
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2581);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(3421);
      END_STATE();
    case 6:
      if (lookahead == '"') ADVANCE(3160);
      if (lookahead == '%') ADVANCE(3171);
      ...
      if (lookahead != 0 &&
          ...
          lookahead != '\n' &&
          lookahead != '\r' &&
          lookahead != ' ') ADVANCE(3170);
      END_STATE();
    case 7:
      if (lookahead == '"') ADVANCE(3160);
      if (lookahead == '%') ADVANCE(3174);
      if (lookahead == '\\') ADVANCE(3173);
      if (lookahead != 0) ADVANCE(3172);
      END_STATE();
    case 8:
      if (lookahead == '"') ADVANCE(3160);
      ...
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(3441);
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(3449);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3447);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3453);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(3450);
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(3444);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3442);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(3443);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(3451);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3452);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3446);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3445);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(3448);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(3438);
      END_STATE();
    case 9:
      ...
      END_STATE();
    case 10:
      if (lookahead == '"') ADVANCE(3161);
      if (lookahead == '\'') ADVANCE(3163);
      if (lookahead == '0') ADVANCE(3423);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(3414);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          lookahead != '\r' &&
          lookahead != ' ') ADVANCE(3427);
      END_STATE();
    case 11:
      if (lookahead == '"') ADVANCE(3161);
      if (lookahead == '\'') ADVANCE(3163);
    ...
    case 68:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ...
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3024);
      END_STATE();
    case 69:
    ...
    case 75:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3190);
      END_STATE();
    case 76:
    ...
    case 264:
      ...
      END_STATE();
    case 265:
      if (lookahead == '0') ADVANCE(3103);
      END_STATE();
    case 266:
      if (lookahead == '0') ADVANCE(3101);
      END_STATE();
    case 267:
      if (lookahead == '0') ADVANCE(3256);
      END_STATE();
    case 268:
      if (lookahead == '0') ADVANCE(3257);
      END_STATE();
    case 269:
      if (lookahead == '0') ADVANCE(3305);
      if (lookahead == 'H') ADVANCE(3308);
      if (lookahead == 'I') ADVANCE(3277);
      if (lookahead == 'L') ADVANCE(3280);
      if (lookahead == 'M') ADVANCE(3284);
      if (lookahead == 'P') ADVANCE(3309);
      if (lookahead == 'T') ADVANCE(3288);
      if (lookahead == 'h') ADVANCE(2308);
      if (lookahead == 'i') ADVANCE(2732);
      if (lookahead == 'l') ADVANCE(2717);
      if (lookahead == 'm') ADVANCE(2430);
      if (lookahead == 'p') ADVANCE(2297);
      if (lookahead == 't') ADVANCE(2823);
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3274);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3304);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(3267);
      if (('1' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'd')) ADVANCE(3327);
      END_STATE();
    case 270:
      if (lookahead == '0') ADVANCE(3426);
      ...
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2802);
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2624);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2324);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(2561);
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2836);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2725);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2737);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2509);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2700);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2655);
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2582);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(2996);
      END_STATE();
    case 271:
      if (lookahead == '0') ADVANCE(264);
      END_STATE();
    case 272:
      if (lookahead == '0') ADVANCE(2964);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2715);
      if (lookahead == 'N' ||
    ...
    case 275:
      ...
      END_STATE();
    case 276:
      if (lookahead == '1') ADVANCE(3186);
      if (lookahead == '2') ADVANCE(3185);
      END_STATE();
    case 277:
      if (lookahead == '1') ADVANCE(3190);
      END_STATE();
    case 278:
    ...
    case 280:
      ...
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2333);
      END_STATE();
    case 281:
      if (lookahead == '2') ADVANCE(3460);
      END_STATE();
    case 282:
      if (lookahead == '2') ADVANCE(3457);
      END_STATE();
    case 283:
      if (lookahead == '2') ADVANCE(3459);
      END_STATE();
    case 284:
      ...
      END_STATE();
    case 285:
      if (lookahead == '2') ADVANCE(3043);
      END_STATE();
    case 286:
      if (lookahead == '2') ADVANCE(3044);
      END_STATE();
    case 287:
    ...
    case 292:
      ...
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2719);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2738);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2679);
      END_STATE();
    case 293:
      if (lookahead == '4') ADVANCE(3459);
      END_STATE();
    case 294:
    ...
    case 300:
      ...
      END_STATE();
    case 301:
      if (lookahead == '6') ADVANCE(3457);
      END_STATE();
    case 302:
      if (lookahead == '6') ADVANCE(3459);
      END_STATE();
    case 303:
      if (lookahead == '6') ADVANCE(263);
      END_STATE();
    case 304:
      if (lookahead == '7') ADVANCE(3104);
      if (lookahead == '8') ADVANCE(3105);
      END_STATE();
    case 305:
      if (lookahead == '8') ADVANCE(3457);
      END_STATE();
    case 306:
      if (lookahead == '8') ADVANCE(3185);
      END_STATE();
    case 307:
    ...
    case 322:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ...
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3026);
      END_STATE();
    case 323:
    ...
    case 324:
      ...
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2955);
      END_STATE();
    case 325:
      if (lookahead == 'A') ADVANCE(273);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2959);
      END_STATE();
    case 326:
      if (lookahead == 'A') ADVANCE(3457);
      END_STATE();
    case 327:
    ...
    case 330:
      ...
      END_STATE();
    case 331:
      if (lookahead == 'B') ADVANCE(3460);
      END_STATE();
    case 332:
      if (lookahead == 'B') ADVANCE(2613);
    ...
    case 337:
      if (lookahead == 'D') ADVANCE(350);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2755);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2353);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2684);
      END_STATE();
    case 338:
      if (lookahead == 'D') ADVANCE(360);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3025);
      END_STATE();
    case 339:
    ...
    case 351:
      ...
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2575);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2899);
      END_STATE();
    case 352:
    ...
    case 360:
      ...
      END_STATE();
    case 361:
      if (lookahead == 'H') ADVANCE(3457);
      END_STATE();
    case 362:
      if (lookahead == 'H') ADVANCE(325);
      if (lookahead == 'h') ADVANCE(2729);
      if (lookahead == 'E' ||
      ...
      END_STATE();
    case 363:
      if (lookahead == 'I') ADVANCE(2843);
      if (lookahead == 'e') ADVANCE(513);
      if (lookahead == 'i') ADVANCE(406);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2696);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3026);
      END_STATE();
    ...
    case 372:
      ...
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2599);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(3026);
      END_STATE();
    case 373:
      if (lookahead == 'L') ADVANCE(386);
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2385);
      END_STATE();
    case 374:
    ...
    case 382:
      ...
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2786);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2428);
      END_STATE();
    case 383:
      if (lookahead == 'O') ADVANCE(2955);
    ...
    case 390:
      ...
      END_STATE();
    case 391:
      if (lookahead == 'P') ADVANCE(3460);
      END_STATE();
    case 392:
      if (lookahead == 'P') ADVANCE(281);
      END_STATE();
    case 393:
      if (lookahead == 'P') ADVANCE(3204);
      if (lookahead == 'p') ADVANCE(3205);
      END_STATE();
    case 394:
      if (lookahead == 'P') ADVANCE(348);
      END_STATE();
    case 395:
      if (lookahead == 'P') ADVANCE(2726);
    ...
    case 407:
      ...
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2710);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2653);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2514);
      if (lookahead == 'U' ||
    ...
    case 422:
      ...
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2685);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2783);
      if (lookahead == 'O' ||
    ...
    case 431:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(3024);
      END_STATE();
    case 432:
    ...
    case 513:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'e')) ADVANCE(3025);
      END_STATE();
    case 514:
      if (lookahead == 'b') ADVANCE(3094);
      END_STATE();
    case 515:
      if (lookahead == 'b') ADVANCE(3058);
      END_STATE();
    case 516:
      if (lookahead == 'b') ADVANCE(3059);
      END_STATE();
    case 517:
    ...
    case 612:
      ...
      END_STATE();
    case 613:
      if (lookahead == 'd') ADVANCE(3212);
      END_STATE();
    case 614:
      if (lookahead == 'd') ADVANCE(3213);
      END_STATE();
    case 615:
      if (lookahead == 'd') ADVANCE(3124);
      END_STATE();
    case 616:
    ...
    case 714:
      ...
      END_STATE();
    case 715:
      if (lookahead == 'e') ADVANCE(3223);
      END_STATE();
    case 716:
      if (lookahead == 'e') ADVANCE(3120);
      END_STATE();
    case 717:
      if (lookahead == 'e') ADVANCE(3121);
      END_STATE();
    case 718:
    ...
    case 1006:
      ...
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2889);
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2285);
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2625);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2318);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2702);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2531);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2426);
      if (lookahead == 'S' ||
    ...
    case 1008:
      ...
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2966);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2741);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2567);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2447);
      if (lookahead == 'S' ||
    ...
    case 1016:
      ...
      END_STATE();
    case 1017:
      if (lookahead == 'g') ADVANCE(3262);
      END_STATE();
    case 1018:
      if (lookahead == 'g') ADVANCE(3099);
      END_STATE();
    case 1019:
      if (lookahead == 'g') ADVANCE(3181);
      END_STATE();
    case 1020:
      if (lookahead == 'g') ADVANCE(1527);
      END_STATE();
    case 1021:
      if (lookahead == 'g') ADVANCE(3140);
      END_STATE();
    case 1022:
      if (lookahead == 'g') ADVANCE(3067);
      END_STATE();
    case 1023:
      if (lookahead == 'g') ADVANCE(3182);
      END_STATE();
    case 1024:
      if (lookahead == 'g') ADVANCE(3068);
      END_STATE();
    case 1025:
      if (lookahead == 'g') ADVANCE(3139);
      END_STATE();
    case 1026:
      if (lookahead == 'g') ADVANCE(3087);
      END_STATE();
    case 1027:
      if (lookahead == 'g') ADVANCE(3069);
      END_STATE();
    case 1028:
    ...
    case 1079:
      ...
      END_STATE();
    case 1080:
      if (lookahead == 'h') ADVANCE(3180);
      END_STATE();
    case 1081:
      if (lookahead == 'h') ADVANCE(3090);
      END_STATE();
    case 1082:
      if (lookahead == 'h') ADVANCE(3216);
      END_STATE();
    case 1083:
      if (lookahead == 'h') ADVANCE(3258);
      END_STATE();
    case 1084:
    ...
    case 1258:
      ...
      END_STATE();
    case 1259:
      if (lookahead == 'k') ADVANCE(3098);
      END_STATE();
    case 1260:
      if (lookahead == 'k') ADVANCE(3138);
      END_STATE();
    case 1261:
      if (lookahead == 'k') ADVANCE(1670);
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2841);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2654);
      END_STATE();
    case 1262:
    ...
    case 1281:
      ...
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2571);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2465);
      if (lookahead == 'S' ||
    ...
    case 1290:
      ...
      END_STATE();
    case 1291:
      if (lookahead == 'l') ADVANCE(3108);
      END_STATE();
    case 1292:
      if (lookahead == 'l') ADVANCE(3260);
      END_STATE();
    case 1293:
    ...
    case 1294:
      ...
      END_STATE();
    case 1295:
      if (lookahead == 'l') ADVANCE(3189);
      END_STATE();
    case 1296:
      if (lookahead == 'l') ADVANCE(3194);
      END_STATE();
    case 1297:
      if (lookahead == 'l') ADVANCE(3348);
      END_STATE();
    case 1298:
      if (lookahead == 'l') ADVANCE(3346);
      END_STATE();
    case 1299:
      if (lookahead == 'l') ADVANCE(3347);
      END_STATE();
    case 1300:
      if (lookahead == 'l') ADVANCE(3050);
      END_STATE();
    case 1301:
      if (lookahead == 'l') ADVANCE(3349);
      END_STATE();
    case 1302:
      if (lookahead == 'l') ADVANCE(3192);
      END_STATE();
    case 1303:
      if (lookahead == 'l') ADVANCE(3191);
      END_STATE();
    case 1304:
      if (lookahead == 'l') ADVANCE(3375);
      END_STATE();
    case 1305:
    ...
    case 1389:
      ...
      END_STATE();
    case 1390:
      if (lookahead == 'm') ADVANCE(3217);
      END_STATE();
    case 1391:
      if (lookahead == 'm') ADVANCE(3070);
      END_STATE();
    case 1392:
      if (lookahead == 'm') ADVANCE(3218);
      END_STATE();
    case 1393:
      if (lookahead == 'm') ADVANCE(3132);
      END_STATE();
    case 1394:
      if (lookahead == 'm') ADVANCE(3071);
      END_STATE();
    case 1395:
      if (lookahead == 'm') ADVANCE(3046);
      END_STATE();
    case 1396:
    ...
    case 1449:
      ...
      END_STATE();
    case 1450:
      if (lookahead == 'n') ADVANCE(3338);
      END_STATE();
    case 1451:
      if (lookahead == 'n') ADVANCE(3339);
      END_STATE();
    case 1452:
    ...
    case 1454:
      ...
      END_STATE();
    case 1455:
      if (lookahead == 'n') ADVANCE(3089);
      END_STATE();
    case 1456:
      if (lookahead == 'n') ADVANCE(3111);
      END_STATE();
    case 1457:
      if (lookahead == 'n') ADVANCE(3072);
      END_STATE();
    case 1458:
    ...
    case 1563:
      ...
      END_STATE();
    case 1564:
      if (lookahead == 'o') ADVANCE(3353);
      END_STATE();
    case 1565:
      if (lookahead == 'o') ADVANCE(3076);
      END_STATE();
    case 1566:
      if (lookahead == 'o') ADVANCE(3250);
      END_STATE();
    case 1567:
      if (lookahead == 'o') ADVANCE(3251);
      END_STATE();
    case 1568:
      if (lookahead == 'o') ADVANCE(3354);
      END_STATE();
    case 1569:
    ...
    case 1671:
      ...
      END_STATE();
    case 1672:
      if (lookahead == 'p') ADVANCE(3226);
      END_STATE();
    case 1673:
      if (lookahead == 'p') ADVANCE(3100);
      END_STATE();
    case 1674:
      if (lookahead == 'p') ADVANCE(3228);
      END_STATE();
    case 1675:
      if (lookahead == 'p') ADVANCE(3088);
      END_STATE();
    case 1676:
    ...
    case 1735:
      ...
      END_STATE();
    case 1736:
      if (lookahead == 'q') ADVANCE(2279);
      END_STATE();
    case 1737:
      if (lookahead == 'q') ADVANCE(2149);
      END_STATE();
    case 1738:
    ...
    case 1741:
      ...
      END_STATE();
    case 1742:
      if (lookahead == 'r') ADVANCE(3230);
      END_STATE();
    case 1743:
      if (lookahead == 'r') ADVANCE(3082);
      END_STATE();
    case 1744:
      if (lookahead == 'r') ADVANCE(3208);
      END_STATE();
    case 1745:
    ...
    case 1899:
      ...
      END_STATE();
    case 1900:
      if (lookahead == 's') ADVANCE(3083);
      END_STATE();
    case 1901:
      if (lookahead == 's') ADVANCE(3164);
      END_STATE();
    case 1902:
      if (lookahead == 's') ADVANCE(3122);
      END_STATE();
    case 1903:
      if (lookahead == 's') ADVANCE(3187);
      END_STATE();
    case 1904:
      if (lookahead == 's') ADVANCE(3245);
      END_STATE();
    case 1905:
      if (lookahead == 's') ADVANCE(3239);
      END_STATE();
    case 1906:
    ...
    case 1919:
      ...
      END_STATE();
    case 1920:
      if (lookahead == 's') ADVANCE(3219);
      END_STATE();
    case 1921:
      if (lookahead == 's') ADVANCE(3048);
      END_STATE();
    case 1922:
    ...
    case 1925:
      ...
      END_STATE();
    case 1926:
      if (lookahead == 's') ADVANCE(3247);
      END_STATE();
    case 1927:
      if (lookahead == 's') ADVANCE(3248);
      END_STATE();
    case 1928:
      if (lookahead == 's') ADVANCE(3249);
      END_STATE();
    case 1929:
    ...
    case 2144:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3023);
      END_STATE();
    case 2145:
    ...
    case 2226:
      ...
      END_STATE();
    case 2227:
      if (lookahead == 'y') ADVANCE(3040);
      END_STATE();
    case 2228:
      if (lookahead == 'y') ADVANCE(3106);
      END_STATE();
    case 2229:
      if (lookahead == 'y') ADVANCE(3156);
      END_STATE();
    case 2230:
      if (lookahead == 'y') ADVANCE(3141);
      END_STATE();
    case 2231:
      if (lookahead == 'y') ADVANCE(3195);
      END_STATE();
    case 2232:
      if (lookahead == 'y') ADVANCE(3153);
      END_STATE();
    case 2233:
      if (lookahead == 'y') ADVANCE(3152);
      END_STATE();
    case 2234:
      if (lookahead == 'y') ADVANCE(3146);
      END_STATE();
    case 2235:
      if (lookahead == 'y') ADVANCE(3118);
      END_STATE();
    case 2236:
      if (lookahead == 'y') ADVANCE(3214);
      END_STATE();
    case 2237:
      if (lookahead == 'y') ADVANCE(3368);
      END_STATE();
    case 2238:
    ...
    case 2282:
      ...
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2471);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2978);
      END_STATE();
    case 2283:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2828);
    ...
    case 2295:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2601);
      END_STATE();
    case 2296:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2747);
      END_STATE();
    case 2297:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2370);
      END_STATE();
    case 2298:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2370);
    ...
    case 2300:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2926);
      END_STATE();
    case 2301:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2602);
      END_STATE();
    case 2302:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2893);
      END_STATE();
    case 2303:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2817);
      END_STATE();
    case 2304:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2385);
    ...
    case 2305:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2396);
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2319);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2967);
      if (lookahead == 'G' ||
      ...
      if (lookahead == '0' ||
          lookahead == '1' ||
          lookahead == '3') ADVANCE(3253);
      END_STATE();
    case 2306:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2780);
      END_STATE();
    case 2307:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2605);
      END_STATE();
    case 2308:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2841);
    ...
    case 2310:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2675);
      END_STATE();
    case 2311:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2876);
      END_STATE();
    case 2312:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2857);
      END_STATE();
    case 2313:
      if (lookahead == 'A' ||
    ...
    case 2316:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2891);
      END_STATE();
    case 2317:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2928);
      END_STATE();
    case 2318:
      if (lookahead == 'A' ||
    ...
    case 2322:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2510);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2811);
      END_STATE();
    case 2323:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2982);
      END_STATE();
    case 2324:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2669);
      if (lookahead == 'I' ||
    ...
    case 2329:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2909);
      END_STATE();
    case 2330:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2344);
      END_STATE();
    case 2331:
      if (lookahead == 'A' ||
    ...
    case 2337:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2919);
      END_STATE();
    case 2338:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2916);
      END_STATE();
    case 2339:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2772);
      END_STATE();
    case 2340:
      if (lookahead == 'B' ||
    ...
    case 2342:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2320);
      END_STATE();
    case 2343:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2583);
      END_STATE();
    case 2344:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2620);
      END_STATE();
    case 2345:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2592);
      END_STATE();
    case 2346:
      if (lookahead == 'B' ||
    ...
    case 2350:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3328);
      END_STATE();
    case 2351:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3200);
      END_STATE();
    case 2352:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3261);
      END_STATE();
    case 2353:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2609);
      END_STATE();
    case 2354:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2517);
      if (lookahead == 'N' ||
    ...
    case 2364:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2829);
      END_STATE();
    case 2365:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2307);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2595);
      END_STATE();
    case 2366:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2878);
      END_STATE();
    case 2367:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2454);
      END_STATE();
    case 2368:
      if (lookahead == 'C' ||
    ...
    case 2369:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2313);
      END_STATE();
    case 2370:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2587);
      END_STATE();
    case 2371:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2591);
      END_STATE();
    case 2372:
      if (lookahead == 'C' ||
    ...
    case 2377:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3430);
      END_STATE();
    case 2378:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3460);
      END_STATE();
    case 2379:
      if (lookahead == 'D' ||
    ...
    case 2380:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3431);
      END_STATE();
    case 2381:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3211);
      END_STATE();
    case 2382:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3204);
      END_STATE();
    case 2383:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3242);
      END_STATE();
    case 2384:
      if (lookahead == 'D' ||
    ...
    case 2385:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3215);
      END_STATE();
    case 2386:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3261);
      END_STATE();
    case 2387:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2408);
      END_STATE();
    case 2388:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2831);
      END_STATE();
    case 2389:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2571);
    ...
    case 2390:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2296);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2365);
      END_STATE();
    case 2391:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2834);
      END_STATE();
    case 2392:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2838);
      END_STATE();
    case 2393:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2424);
    ...
    case 2396:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2944);
      END_STATE();
    case 2397:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2461);
      END_STATE();
    case 2398:
      if (lookahead == 'D' ||
    ...
    case 2404:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3456);
      END_STATE();
    case 2405:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3429);
      END_STATE();
    case 2406:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3460);
      END_STATE();
    case 2407:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3457);
      END_STATE();
    case 2408:
      if (lookahead == 'E' ||
    ...
    case 2409:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3459);
      END_STATE();
    case 2410:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3246);
      END_STATE();
    case 2411:
      if (lookahead == 'E' ||
    ...
    case 2412:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2977);
      END_STATE();
    case 2413:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3168);
      END_STATE();
    case 2414:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2637);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2387);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2523);
      END_STATE();
    case 2415:
      if (lookahead == 'E' ||
    ...
    case 2416:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3328);
      END_STATE();
    case 2417:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3204);
      END_STATE();
    case 2418:
      if (lookahead == 'E' ||
    ...
    case 2419:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3364);
      END_STATE();
    case 2420:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3166);
      END_STATE();
    case 2421:
      if (lookahead == 'E' ||
    ...
    case 2422:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3207);
      END_STATE();
    case 2423:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2474);
      END_STATE();
    case 2424:
      if (lookahead == 'E' ||
    ...
    case 2428:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2360);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(83);
      END_STATE();
    case 2429:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2376);
      END_STATE();
    case 2430:
      if (lookahead == 'E' ||
    ...
    case 2433:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2949);
      END_STATE();
    case 2434:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2486);
      END_STATE();
    case 2435:
      if (lookahead == 'E' ||
    ...
    case 2442:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2381);
      END_STATE();
    case 2443:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2975);
      END_STATE();
    case 2444:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2858);
      END_STATE();
    case 2445:
      if (lookahead == 'E' ||
    ...
    case 2451:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2623);
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2720);
      END_STATE();
    case 2452:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2386);
      END_STATE();
    case 2453:
      if (lookahead == 'E' ||
    ...
    case 2454:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2604);
      END_STATE();
    case 2455:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2876);
      END_STATE();
    case 2456:
      if (lookahead == 'E' ||
    ...
    case 2474:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2765);
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2865);
      END_STATE();
    case 2475:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2812);
      END_STATE();
    case 2476:
      if (lookahead == 'E' ||
    ...
    case 2482:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2968);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2920);
      END_STATE();
    case 2483:
      if (lookahead == 'E' ||
    ...
    case 2485:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(3328);
      END_STATE();
    case 2486:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(3237);
      END_STATE();
    case 2487:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(2913);
      END_STATE();
    case 2488:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(83);
    ...
    case 2494:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3328);
      END_STATE();
    case 2495:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3256);
      END_STATE();
    case 2496:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3242);
      END_STATE();
    case 2497:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3166);
      END_STATE();
    case 2498:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3207);
      END_STATE();
    case 2499:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2526);
      END_STATE();
    case 2500:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2460);
      END_STATE();
    case 2501:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2698);
    ...
    case 2504:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2441);
      END_STATE();
    case 2505:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2683);
      END_STATE();
    case 2506:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2830);
      END_STATE();
    case 2507:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2829);
      END_STATE();
    case 2508:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2748);
      END_STATE();
    case 2509:
      if (lookahead == 'G' ||
    ...
    case 2514:
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2721);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2614);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2525);
      END_STATE();
    case 2515:
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2697);
      END_STATE();
    case 2516:
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2539);
      END_STATE();
    case 2517:
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2416);
      END_STATE();
    case 2518:
      if (lookahead == 'H' ||
    ...
    case 2521:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2990);
      END_STATE();
    case 2522:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2941);
      END_STATE();
    case 2523:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(3328);
      END_STATE();
    case 2524:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2377);
      ...
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2600);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2314);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2490);
      END_STATE();
    case 2525:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2645);
      END_STATE();
    case 2526:
      if (lookahead == 'I' ||
    ...
    case 2535:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2496);
      END_STATE();
    case 2536:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2388);
      END_STATE();
    case 2537:
      if (lookahead == 'I' ||
    ...
    case 2544:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2884);
      END_STATE();
    case 2545:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2835);
      END_STATE();
    case 2546:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2886);
      END_STATE();
    case 2547:
      if (lookahead == 'I' ||
    ...
    case 2567:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2678);
      END_STATE();
    case 2568:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2907);
      END_STATE();
    case 2569:
      if (lookahead == 'I' ||
    ...
    case 2570:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2374);
      END_STATE();
    case 2571:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2866);
      END_STATE();
    case 2572:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2401);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2938);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2325);
      END_STATE();
    case 2573:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(3362);
      END_STATE();
    case 2574:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(3328);
      END_STATE();
    case 2575:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(3215);
      END_STATE();
    case 2576:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2917);
      END_STATE();
    case 2577:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2917);
    ...
    case 2581:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2382);
      END_STATE();
    case 2582:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2384);
      END_STATE();
    case 2583:
      if (lookahead == 'K' ||
    ...
    case 2584:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2442);
      END_STATE();
    case 2585:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2472);
      END_STATE();
    case 2586:
      if (lookahead == 'K' ||
    ...
    case 2587:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2455);
      END_STATE();
    case 2588:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2870);
      END_STATE();
    case 2589:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2464);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2588);
      END_STATE();
    case 2590:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2667);
      END_STATE();
    case 2591:
      if (lookahead == 'K' ||
    ...
    case 2593:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2676);
      END_STATE();
    case 2594:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2924);
      END_STATE();
    case 2595:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2924);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2342);
      END_STATE();
    case 2596:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2473);
      END_STATE();
    case 2597:
      if (lookahead == 'K' ||
    ...
    case 2600:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3429);
      END_STATE();
    case 2601:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3246);
      END_STATE();
    case 2602:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3240);
      END_STATE();
    case 2603:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3211);
      END_STATE();
    case 2604:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3362);
      END_STATE();
    case 2605:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3204);
      END_STATE();
    case 2606:
      if (lookahead == 'L' ||
    ...
    case 2607:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3364);
      END_STATE();
    case 2608:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2971);
      END_STATE();
    case 2609:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2930);
      END_STATE();
    case 2610:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2957);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2897);
      END_STATE();
    case 2611:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2486);
      END_STATE();
    case 2612:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2973);
      END_STATE();
    case 2613:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2429);
      END_STATE();
    case 2614:
      if (lookahead == 'L' ||
    ...
    case 2621:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2418);
      END_STATE();
    case 2622:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2505);
      END_STATE();
    case 2623:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2488);
      END_STATE();
    case 2624:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2312);
      END_STATE();
    case 2625:
      if (lookahead == 'L' ||
    ...
    case 2628:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2445);
      END_STATE();
    case 2629:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2987);
      END_STATE();
    case 2630:
      if (lookahead == 'L' ||
    ...
    case 2646:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3429);
      END_STATE();
    case 2647:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3246);
      END_STATE();
    case 2648:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3240);
      END_STATE();
    case 2649:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3237);
      END_STATE();
    case 2650:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3215);
      END_STATE();
    case 2651:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2362);
    ...
    case 2655:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2590);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2606);
      END_STATE();
    case 2656:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2494);
      END_STATE();
    case 2657:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2710);
    ...
    case 2658:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2497);
      END_STATE();
    case 2659:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2498);
      END_STATE();
    case 2660:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2612);
      END_STATE();
    case 2661:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2831);
      END_STATE();
    case 2662:
      if (lookahead == 'N' ||
    ...
    case 2663:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2468);
      END_STATE();
    case 2664:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2410);
      END_STATE();
    case 2665:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2838);
      END_STATE();
    case 2666:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2629);
      END_STATE();
    case 2667:
      if (lookahead == 'N' ||
    ...
    case 2676:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2727);
      END_STATE();
    case 2677:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2921);
      END_STATE();
    case 2678:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2555);
      END_STATE();
    case 2679:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2593);
      END_STATE();
    case 2680:
      if (lookahead == 'N' ||
    ...
    case 2688:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2393);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2391);
      END_STATE();
    case 2689:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(3328);
      END_STATE();
    case 2690:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(3200);
      END_STATE();
    case 2691:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(3215);
      END_STATE();
    case 2692:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2652);
      END_STATE();
    case 2693:
      if (lookahead == 'O' ||
    ...
    case 2694:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2960);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2528);
      END_STATE();
    case 2695:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2960);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2538);
      END_STATE();
    case 2696:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2758);
      END_STATE();
    case 2697:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2953);
      END_STATE();
    case 2698:
      if (lookahead == 'O' ||
    ...
    case 2700:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2487);
      END_STATE();
    case 2701:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2963);
      END_STATE();
    case 2702:
      if (lookahead == 'O' ||
    ...
    case 2713:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2385);
      END_STATE();
    case 2714:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2778);
      END_STATE();
    case 2715:
      if (lookahead == 'O' ||
    ...
    case 2716:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2789);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2908);
      END_STATE();
    case 2717:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2724);
      END_STATE();
    case 2718:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2838);
      END_STATE();
    case 2719:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2713);
      END_STATE();
    case 2720:
      if (lookahead == 'O' ||
    ...
    case 2730:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2774);
      END_STATE();
    case 2731:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2788);
      END_STATE();
    case 2732:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2338);
    ...
    case 2744:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3246);
      END_STATE();
    case 2745:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3328);
      END_STATE();
    case 2746:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2993);
      END_STATE();
    case 2747:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3204);
      END_STATE();
    case 2748:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3256);
      END_STATE();
    case 2749:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3200);
      END_STATE();
    case 2750:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2775);
    ...
    case 2754:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2495);
      END_STATE();
    case 2755:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2726);
      END_STATE();
    case 2756:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2508);
      END_STATE();
    case 2757:
      if (lookahead == 'P' ||
    ...
    case 2762:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2711);
      END_STATE();
    case 2763:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2704);
      if (lookahead == 'T' ||
    ...
    case 2766:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2894);
      END_STATE();
    case 2767:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2790);
      END_STATE();
    case 2768:
      if (lookahead == 'P' ||
    ...
    case 2775:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3429);
      END_STATE();
    case 2776:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3198);
      END_STATE();
    case 2777:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3185);
      END_STATE();
    case 2778:
      if (lookahead == 'R' ||
    ...
    case 2780:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3204);
      END_STATE();
    case 2781:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3364);
      END_STATE();
    case 2782:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2527);
    ...
    case 2789:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2974);
      END_STATE();
    case 2790:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2444);
      END_STATE();
    case 2791:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2615);
      END_STATE();
    case 2792:
      if (lookahead == 'R' ||
    ...
    case 2793:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2603);
      END_STATE();
    case 2794:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2874);
      END_STATE();
    case 2795:
      if (lookahead == 'R' ||
    ...
    case 2803:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2880);
      END_STATE();
    case 2804:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2543);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2483);
      END_STATE();
    case 2805:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2433);
      END_STATE();
    case 2806:
      if (lookahead == 'R' ||
    ...
    case 2829:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3246);
      END_STATE();
    case 2830:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3240);
      END_STATE();
    case 2831:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3168);
      END_STATE();
    case 2832:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3431);
      END_STATE();
    case 2833:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3211);
      END_STATE();
    case 2834:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3204);
      END_STATE();
    case 2835:
      if (lookahead == 'S' ||
    ...
    case 2836:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3238);
      END_STATE();
    case 2837:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3200);
      END_STATE();
    case 2838:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3166);
      END_STATE();
    case 2839:
      if (lookahead == 'S' ||
    ...
    case 2842:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2881);
      END_STATE();
    case 2843:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2284);
      END_STATE();
    case 2844:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2533);
    ...
    case 2856:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2915);
      END_STATE();
    case 2857:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2852);
      END_STATE();
    case 2858:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2851);
      END_STATE();
    case 2859:
      if (lookahead == 'S' ||
    ...
    case 2864:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2326);
      END_STATE();
    case 2865:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2479);
      END_STATE();
    case 2866:
      if (lookahead == 'S' ||
    ...
    case 2868:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2331);
      END_STATE();
    case 2869:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2568);
      END_STATE();
    case 2870:
      if (lookahead == 'S' ||
    ...
    case 2871:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2481);
      END_STATE();
    case 2872:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3429);
      END_STATE();
    case 2873:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3159);
      END_STATE();
    case 2874:
      if (lookahead == 'T' ||
    ...
    case 2875:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3362);
      END_STATE();
    case 2876:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3328);
      END_STATE();
    case 2877:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3204);
      END_STATE();
    case 2878:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3200);
      END_STATE();
    case 2879:
      if (lookahead == 'T' ||
    ...
    case 2880:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3207);
      END_STATE();
    case 2881:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2775);
      END_STATE();
    case 2882:
      if (lookahead == 'T' ||
    ...
    case 2884:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2973);
      END_STATE();
    case 2885:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2522);
      END_STATE();
    case 2886:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2976);
      END_STATE();
    case 2887:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2731);
      END_STATE();
    case 2888:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2760);
    ...
    case 2891:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2560);
      END_STATE();
    case 2892:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2712);
      END_STATE();
    case 2893:
      if (lookahead == 'T' ||
    ...
    case 2894:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2689);
      END_STATE();
    case 2895:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2838);
      END_STATE();
    case 2896:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2450);
      END_STATE();
    case 2897:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2690);
      END_STATE();
    case 2898:
      if (lookahead == 'T' ||
    ...
    case 2899:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2691);
      END_STATE();
    case 2900:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2456);
      END_STATE();
    case 2901:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2419);
      END_STATE();
    case 2902:
      if (lookahead == 'T' ||
    ...
    case 2913:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(3201);
      END_STATE();
    case 2914:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(3261);
      END_STATE();
    case 2915:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2343);
      END_STATE();
    case 2916:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2485);
      END_STATE();
    case 2917:
      if (lookahead == 'U' ||
    ...
    case 2922:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2791);
      END_STATE();
    case 2923:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2793);
      END_STATE();
    case 2924:
      if (lookahead == 'U' ||
    ...
    case 2925:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2558);
      END_STATE();
    case 2926:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2618);
      END_STATE();
    case 2927:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2536);
      END_STATE();
    case 2928:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2617);
      END_STATE();
    case 2929:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2792);
      END_STATE();
    case 2930:
      if (lookahead == 'U' ||
    ...
    case 2931:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2848);
      END_STATE();
    case 2932:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2896);
      END_STATE();
    case 2933:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2818);
      END_STATE();
    case 2934:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2849);
      END_STATE();
    case 2935:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2345);
      END_STATE();
    case 2936:
      if (lookahead == 'U' ||
    ...
    case 2937:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2864);
      END_STATE();
    case 2938:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2868);
      END_STATE();
    case 2939:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2693);
    ...
    case 2940:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2315);
      END_STATE();
    case 2941:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2425);
      END_STATE();
    case 2942:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2707);
      END_STATE();
    case 2943:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2835);
      END_STATE();
    case 2944:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2310);
      END_STATE();
    case 2945:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2475);
      END_STATE();
    case 2946:
      if (lookahead == 'V' ||
    ...
    case 2947:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2734);
      END_STATE();
    case 2948:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2462);
      END_STATE();
    case 2949:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2596);
      END_STATE();
    case 2950:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2477);
      END_STATE();
    case 2951:
      if (lookahead == 'V' ||
    ...
    case 2956:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2650);
      END_STATE();
    case 2957:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2323);
      END_STATE();
    case 2958:
      if (lookahead == 'W' ||
    ...
    case 2960:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2663);
      END_STATE();
    case 2961:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2855);
      END_STATE();
    case 2962:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(3429);
      END_STATE();
    case 2963:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(3166);
      END_STATE();
    case 2964:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2631);
      END_STATE();
    case 2965:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2757);
      END_STATE();
    case 2966:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2762);
      END_STATE();
    case 2967:
      if (lookahead == 'X' ||
    ...
    case 2968:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2773);
      END_STATE();
    case 2969:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(3020);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3026);
      END_STATE();
    ...
    case 2973:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(3168);
      END_STATE();
    case 2974:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(3328);
      END_STATE();
    case 2975:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2804);
      END_STATE();
    case 2976:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(3166);
      END_STATE();
    case 2977:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2850);
      END_STATE();
    case 2978:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2766);
      END_STATE();
    case 2979:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2830);
      END_STATE();
    case 2980:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2829);
      END_STATE();
    case 2981:
      if (lookahead == 'Y' ||
    ...
    case 2990:
      if (lookahead == 'Z' ||
          lookahead == 'z') ADVANCE(2405);
      END_STATE();
    case 2991:
      if (lookahead == 'e' ||
          lookahead == 't') ADVANCE(3433);
      END_STATE();
    case 2992:
      if (lookahead == '-' ||
          lookahead == 'c' ||
          lookahead == 't') ADVANCE(3437);
      END_STATE();
    case 2993:
      if (('6' <= lookahead && lookahead <= '8')) ADVANCE(3256);
      END_STATE();
    case 2994:
      if (lookahead == 'd' ||
          lookahead == 'm' ||
    ...
    case 2995:
      if (lookahead == 'd' ||
          ...
          lookahead == 'w' ||
          lookahead == 'y') ADVANCE(3425);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(2994);
      END_STATE();
    case 2996:
      if (lookahead == 'd' ||
          lookahead == 'm' ||
          lookahead == 'w' ||
          lookahead == 'y') ADVANCE(3425);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(2995);
      END_STATE();
    case 2997:
      if (lookahead == 'd' ||
          lookahead == 'm' ||
    ...
    case 2998:
      if (lookahead == 'f' ||
          lookahead == 'n' ||
          lookahead == 't' ||
          lookahead == 'z') ADVANCE(3436);
      if (lookahead == 'g') ADVANCE(2991);
      if (lookahead == 'l') ADVANCE(2991);
      END_STATE();
    case 2999:
      if (('0' <= lookahead && lookahead <= '3')) ADVANCE(3193);
      END_STATE();
    case 3000:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(39);
      if (('a' <= lookahead && lookahead <= 'z')) ADVANCE(3410);
      END_STATE();
    case 3001:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3411);
      END_STATE();
    case 3002:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3424);
      END_STATE();
    case 3003:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3425);
      END_STATE();
    case 3004:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(411);
      END_STATE();
    case 3005:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3004);
      END_STATE();
    case 3006:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3002);
      END_STATE();
    case 3007:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3009);
      END_STATE();
    case 3008:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3003);
      END_STATE();
    case 3009:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(222);
      END_STATE();
    case 3010:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3005);
      END_STATE();
    case 3011:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3006);
      END_STATE();
    case 3012:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3010);
      END_STATE();
    case 3013:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(166);
      END_STATE();
    case 3014:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3011);
      END_STATE();
    case 3015:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3012);
      END_STATE();
    case 3016:
    ...
    case 3020:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3027);
      END_STATE();
    case 3021:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
    ...
    case 3022:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3021);
      END_STATE();
    case 3023:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3022);
      END_STATE();
    case 3024:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
    ...
    case 3029:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3327);
      END_STATE();
    case 3030:
      if (lookahead == '+' ||
          ('/' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(3373);
      END_STATE();
    case 3031:
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != ' ' &&
          lookahead != '=') ADVANCE(3227);
      END_STATE();
    case 3032:
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(3438);
    ...
    case 3033:
      ...
      if (lookahead == 'K') ADVANCE(2403);
      if (lookahead == 'L') ADVANCE(2283);
      if (lookahead == 'M') ADVANCE(2334);
      if (lookahead == 'N') ADVANCE(2692);
      if (lookahead == 'O') ADVANCE(2782);
      if (lookahead == 'P') ADVANCE(2912);
      ...
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(3461);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(3027);
      END_STATE();
    case 3034:
    ...
    case 3171:
      ACCEPT_TOKEN(aux_sym__command_token1);
      if (aux_sym__command_format_token1_character_set_1(lookahead)) ADVANCE(3179);
      END_STATE();
    case 3172:
    ...
    case 3265:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'H') ADVANCE(3318);
      if (lookahead == 'h') ADVANCE(2416);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3324);
      END_STATE();
    case 3266:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'H') ADVANCE(3268);
      if (lookahead == 'h') ADVANCE(2539);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3324);
      END_STATE();
    case 3267:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3326);
      END_STATE();
    case 3268:
      ACCEPT_TOKEN(aux_sym__debug_token1);
    ...
    case 3269:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'I') ADVANCE(3325);
      if (lookahead == 'i') ADVANCE(3328);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3325);
      END_STATE();
    case 3270:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'K') ADVANCE(3317);
    ...
    case 3271:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'K') ADVANCE(3303);
      if (lookahead == 'k') ADVANCE(2924);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3324);
      END_STATE();
    case 3272:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'K') ADVANCE(3323);
      if (lookahead == 'k') ADVANCE(3328);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3323);
      END_STATE();
    case 3273:
    ...
    case 3274:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'f')) ADVANCE(3326);
      END_STATE();
    case 3275:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'M') ADVANCE(3281);
      if (lookahead == 'm') ADVANCE(2716);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3325);
      END_STATE();
    case 3276:
    ...
    case 3282:
      ...
      if (lookahead == 'o') ADVANCE(3328);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3322);
      END_STATE();
    case 3283:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'O') ADVANCE(3314);
    ...
    case 3284:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'P') ADVANCE(3269);
      if (lookahead == 'p') ADVANCE(2523);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3275);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3326);
      END_STATE();
    case 3285:
    ...
    case 3286:
      ...
      if (lookahead == 'p') ADVANCE(2894);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3324);
      END_STATE();
    case 3287:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'P') ADVANCE(3322);
      if (lookahead == 'p') ADVANCE(3328);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3322);
      END_STATE();
    case 3288:
    ...
    case 3293:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'S') ADVANCE(3300);
      if (lookahead == 's') ADVANCE(2876);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3324);
      END_STATE();
    case 3294:
    ...
    case 3295:
      ...
      if (lookahead == 't') ADVANCE(2760);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3325);
      END_STATE();
    case 3296:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'T') ADVANCE(3310);
    ...
    case 3301:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'U') ADVANCE(3319);
      if (lookahead == 'u') ADVANCE(2485);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3324);
      END_STATE();
    case 3302:
    ...
    case 3304:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'X') ADVANCE(3295);
      if (lookahead == 'x') ADVANCE(2888);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3326);
      END_STATE();
    case 3305:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'X') ADVANCE(3320);
      if (lookahead == 'x') ADVANCE(3029);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3326);
      END_STATE();
    case 3306:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'Y') ADVANCE(3286);
      if (lookahead == 'y') ADVANCE(2766);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3325);
      END_STATE();
    case 3307:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'Y') ADVANCE(3322);
    ...
    case 3310:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(3294);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'f')) ADVANCE(3322);
      END_STATE();
    case 3311:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(3301);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3325);
      END_STATE();
    case 3312:
    ...
    case 3319:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(3323);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'e')) ADVANCE(3323);
      END_STATE();
    case 3320:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (('0' <= lookahead && lookahead <= '9') ||
    ...
    case 3321:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3263);
      END_STATE();
    case 3322:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (('0' <= lookahead && lookahead <= '9') ||
    ...
    case 3378:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3377);
      END_STATE();
    case 3379:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3378);
      END_STATE();
    case 3380:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3379);
      END_STATE();
    case 3381:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3380);
      END_STATE();
    case 3382:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3381);
      END_STATE();
    case 3383:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3382);
      END_STATE();
    case 3384:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3383);
      END_STATE();
    case 3385:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3384);
      END_STATE();
    case 3386:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3385);
      END_STATE();
    case 3387:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3386);
      END_STATE();
    case 3388:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3387);
      END_STATE();
    case 3389:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3388);
      END_STATE();
    case 3390:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3389);
      END_STATE();
    case 3391:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3390);
      END_STATE();
    case 3392:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3391);
      END_STATE();
    case 3393:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3392);
      END_STATE();
    case 3394:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3393);
      END_STATE();
    case 3395:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3394);
      END_STATE();
    case 3396:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
    ...
    case 3412:
      ...
      if (lookahead == 'T') ADVANCE(3019);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3422);
      END_STATE();
    case 3413:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3412);
      END_STATE();
    case 3414:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3414);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          lookahead != '\r' &&
    ...
    case 3416:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3413);
      END_STATE();
    case 3417:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3416);
      END_STATE();
    case 3418:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3417);
      END_STATE();
    case 3419:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3418);
      END_STATE();
    case 3420:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3419);
      END_STATE();
    case 3421:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3420);
      END_STATE();
    case 3422:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3422);
    ...
    case 3426:
      ACCEPT_TOKEN(sym_expire_time);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3007);
      END_STATE();
    case 3427:
