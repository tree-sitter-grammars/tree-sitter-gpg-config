...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(3205);
      if (('0' <= lookahead && lookahead <= '3')) ADVANCE(3203);
      if ((11 <= lookahead && lookahead <= '\r')) ADVANCE(3205);
      if (lookahead != 0) ADVANCE(3203);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(3068);
      END_STATE();
    case 2:
      ...
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(3494);
      if (lookahead != 0 &&
          lookahead != 11 &&
          lookahead != '\f') ADVANCE(3203);
      END_STATE();
    case 3:
      if (lookahead == '\n') ADVANCE(3068);
      if (lookahead == '\r') ADVANCE(3375);
      if (lookahead == '%') ADVANCE(3376);
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(3494);
      if (lookahead != 0 &&
          lookahead != '=') ADVANCE(3374);
      END_STATE();
    case 4:
      if (lookahead == '!') ADVANCE(3364);
      if (lookahead == '%') ADVANCE(3376);
    ...
    case 5:
      ...
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2280);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2319);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2816);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(2551);
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2692);
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2308);
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2653);
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2426);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2397);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2416);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2780);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2297);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2417);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2454);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2537);
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2456);
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2593);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(3454);
      END_STATE();
    case 6:
      if (lookahead == '"') ADVANCE(3193);
      if (lookahead == '%') ADVANCE(3204);
      ...
      if (lookahead != 0 &&
          ...
          lookahead != ' ') ADVANCE(3203);
      END_STATE();
    case 7:
      if (lookahead == '"') ADVANCE(3193);
      if (lookahead == '%') ADVANCE(3207);
      if (lookahead == '\\') ADVANCE(3206);
      if (lookahead != 0) ADVANCE(3205);
      END_STATE();
    case 8:
      if (lookahead == '"') ADVANCE(3193);
      ...
      if (lookahead == '\t' ||
          lookahead == ' ') ADVANCE(3474);
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(3482);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3480);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3486);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(3483);
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(3477);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3475);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(3476);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(3484);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3485);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3479);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3478);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(3481);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(3471);
      END_STATE();
    case 9:
    ...
    case 10:
      ...
      if (lookahead == '0') ADVANCE(3456);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(3447);
      if (lookahead != 0 &&
          (lookahead < '\t' || '\r' < lookahead) &&
          lookahead != ' ') ADVANCE(3460);
      END_STATE();
    case 11:
      if (lookahead == '"') ADVANCE(3194);
      if (lookahead == '\'') ADVANCE(3196);
    ...
    case 56:
      ...
      END_STATE();
    case 57:
      if (lookahead == '-') ADVANCE(3243);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2428);
      if (lookahead == 'N' ||
    ...
    case 75:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3223);
      END_STATE();
    case 76:
    ...
    case 80:
      ...
      END_STATE();
    case 81:
      if (lookahead == '-') ADVANCE(2974);
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2949);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(2299);
      END_STATE();
    case 82:
    ...
    case 269:
      ...
      END_STATE();
    case 270:
      if (lookahead == '0') ADVANCE(3134);
      END_STATE();
    case 271:
      if (lookahead == '0') ADVANCE(3289);
      END_STATE();
    case 272:
      if (lookahead == '0') ADVANCE(3290);
      END_STATE();
    case 273:
      if (lookahead == '0') ADVANCE(3338);
      if (lookahead == 'H') ADVANCE(3341);
      if (lookahead == 'I') ADVANCE(3310);
      if (lookahead == 'L') ADVANCE(3313);
      if (lookahead == 'M') ADVANCE(3317);
      if (lookahead == 'P') ADVANCE(3342);
      if (lookahead == 'T') ADVANCE(3321);
      if (lookahead == 'h') ADVANCE(2307);
      if (lookahead == 'i') ADVANCE(2748);
      if (lookahead == 'l') ADVANCE(2733);
      if (lookahead == 'm') ADVANCE(2434);
      if (lookahead == 'p') ADVANCE(2296);
      if (lookahead == 't') ADVANCE(2848);
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3307);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3337);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(3300);
      if (('1' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'd')) ADVANCE(3360);
      END_STATE();
    case 274:
      if (lookahead == '0') ADVANCE(3459);
      if (lookahead == 'R') ADVANCE(364);
      if (lookahead == 'S') ADVANCE(361);
      if (lookahead == 'r') ADVANCE(2438);
      if (lookahead == 's') ADVANCE(2463);
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2623);
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2830);
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2632);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2321);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(2576);
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2861);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2739);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2753);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2519);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2718);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2670);
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2595);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(3029);
      END_STATE();
    case 275:
    ...
    case 276:
      ...
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2731);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2758);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2528);
      END_STATE();
    case 277:
      if (lookahead == '1') ADVANCE(3492);
    ...
    case 279:
      ...
      END_STATE();
    case 280:
      if (lookahead == '1') ADVANCE(3219);
      if (lookahead == '2') ADVANCE(3218);
      END_STATE();
    case 281:
      if (lookahead == '1') ADVANCE(3223);
      END_STATE();
    case 282:
    ...
    case 284:
      ...
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2332);
      END_STATE();
    case 285:
      if (lookahead == '2') ADVANCE(3493);
      END_STATE();
    case 286:
      if (lookahead == '2') ADVANCE(3490);
      END_STATE();
    case 287:
      if (lookahead == '2') ADVANCE(3492);
      END_STATE();
    case 288:
    ...
    case 296:
      ...
      if (lookahead == 'b') ADVANCE(2303);
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2734);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2755);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2695);
      END_STATE();
    case 297:
      if (lookahead == '4') ADVANCE(3492);
      END_STATE();
    case 298:
    ...
    case 304:
      ...
      END_STATE();
    case 305:
      if (lookahead == '6') ADVANCE(3490);
      END_STATE();
    case 306:
      if (lookahead == '6') ADVANCE(3492);
      END_STATE();
    case 307:
      if (lookahead == '6') ADVANCE(267);
      END_STATE();
    case 308:
      if (lookahead == '7') ADVANCE(3137);
      if (lookahead == '8') ADVANCE(3138);
      END_STATE();
    case 309:
      if (lookahead == '8') ADVANCE(3490);
      END_STATE();
    case 310:
      if (lookahead == '8') ADVANCE(3218);
      END_STATE();
    case 311:
    ...
    case 339:
      if (lookahead == 'D') ADVANCE(350);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2773);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2700);
      END_STATE();
    case 340:
    ...
    case 351:
      ...
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2587);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2926);
      END_STATE();
    case 352:
    ...
    case 358:
      ...
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2501);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2332);
      END_STATE();
    case 359:
      if (lookahead == 'H') ADVANCE(3489);
      ...
      END_STATE();
    case 360:
      if (lookahead == 'H') ADVANCE(3490);
      END_STATE();
    case 361:
      if (lookahead == 'H') ADVANCE(329);
      if (lookahead == 'h') ADVANCE(2745);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2625);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2847);
      END_STATE();
    case 362:
      if (lookahead == 'I') ADVANCE(2868);
      if (lookahead == 'e') ADVANCE(508);
      if (lookahead == 'i') ADVANCE(403);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2715);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3059);
      END_STATE();
    case 363:
      ...
      if (lookahead == 'S') ADVANCE(327);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2772);
      END_STATE();
    case 364:
      if (lookahead == 'I') ADVANCE(391);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2657);
      END_STATE();
    case 365:
    ...
    case 371:
      ...
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2349);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2621);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(3059);
      END_STATE();
    case 372:
      if (lookahead == 'L') ADVANCE(385);
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2387);
      END_STATE();
    case 373:
    ...
    case 379:
      ...
      END_STATE();
    case 380:
      if (lookahead == 'N') ADVANCE(2869);
      if (lookahead == 'n') ADVANCE(650);
      if (lookahead == 't') ADVANCE(23);
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2807);
      if (lookahead == 'L' ||
    ...
    case 392:
      ...
      END_STATE();
    case 393:
      if (lookahead == 'R') ADVANCE(2928);
      if (lookahead == 'r') ADVANCE(406);
      END_STATE();
    case 394:
      if (lookahead == 'R') ADVANCE(2929);
    ...
    case 404:
      ...
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2414);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2724);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2669);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2524);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2564);
      END_STATE();
    case 405:
    ...
    case 418:
      ...
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2701);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2804);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2389);
      END_STATE();
    case 419:
    ...
    case 422:
      ...
      END_STATE();
    case 423:
      if (lookahead == 'a') ADVANCE(3175);
      END_STATE();
    case 424:
      if (lookahead == 'a') ADVANCE(3074);
      END_STATE();
    case 425:
      if (lookahead == 'a') ADVANCE(3075);
      END_STATE();
    case 426:
      if (lookahead == 'a') ADVANCE(2143);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(3057);
      END_STATE();
    case 427:
    ...
    case 507:
      ...
      END_STATE();
    case 508:
      if (lookahead == 'b') ADVANCE(2141);
      if (lookahead == 'f') ADVANCE(426);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'e')) ADVANCE(3058);
      END_STATE();
    case 509:
      if (lookahead == 'b') ADVANCE(3127);
      END_STATE();
    case 510:
      if (lookahead == 'b') ADVANCE(3091);
      END_STATE();
    case 511:
      if (lookahead == 'b') ADVANCE(3092);
      END_STATE();
    case 512:
    ...
    case 559:
      ...
      if (lookahead == 'q') ADVANCE(2139);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2289);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2913);
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2710);
      END_STATE();
    case 560:
    ...
    case 608:
      ...
      END_STATE();
    case 609:
      if (lookahead == 'd') ADVANCE(3246);
      END_STATE();
    case 610:
      if (lookahead == 'd') ADVANCE(3157);
      END_STATE();
    case 611:
      if (lookahead == 'd') ADVANCE(3163);
      END_STATE();
    case 612:
      if (lookahead == 'd') ADVANCE(3129);
      END_STATE();
    case 613:
      if (lookahead == 'd') ADVANCE(3402);
      END_STATE();
    case 614:
      if (lookahead == 'd') ADVANCE(3161);
      END_STATE();
    case 615:
      if (lookahead == 'd') ADVANCE(3162);
      END_STATE();
    case 616:
    ...
    case 688:
      ...
      END_STATE();
    case 689:
      if (lookahead == 'e') ADVANCE(3216);
      END_STATE();
    case 690:
      if (lookahead == 'e') ADVANCE(3096);
      END_STATE();
    case 691:
      if (lookahead == 'e') ADVANCE(3394);
      END_STATE();
    case 692:
    ...
    case 971:
      ...
      END_STATE();
    case 972:
      if (lookahead == 'f') ADVANCE(3142);
      END_STATE();
    case 973:
      if (lookahead == 'f') ADVANCE(3070);
      END_STATE();
    case 974:
    ...
    case 1004:
      ...
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2916);
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2284);
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2641);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2316);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2716);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2540);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2430);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2436);
      END_STATE();
    case 1005:
    ...
    case 1006:
      ...
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2643);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2998);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2759);
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2579);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2448);
      if (lookahead == 'S' ||
    ...
    case 1014:
      ...
      END_STATE();
    case 1015:
      if (lookahead == 'g') ADVANCE(3295);
      END_STATE();
    case 1016:
      if (lookahead == 'g') ADVANCE(3132);
      END_STATE();
    case 1017:
      if (lookahead == 'g') ADVANCE(3214);
      END_STATE();
    case 1018:
    ...
    case 1021:
      ...
      END_STATE();
    case 1022:
      if (lookahead == 'g') ADVANCE(3101);
      END_STATE();
    case 1023:
      if (lookahead == 'g') ADVANCE(3172);
      END_STATE();
    case 1024:
    ...
    case 1077:
      ...
      END_STATE();
    case 1078:
      if (lookahead == 'h') ADVANCE(3213);
      END_STATE();
    case 1079:
      if (lookahead == 'h') ADVANCE(3123);
      END_STATE();
    case 1080:
      if (lookahead == 'h') ADVANCE(3249);
      END_STATE();
    case 1081:
      if (lookahead == 'h') ADVANCE(3291);
      END_STATE();
    case 1082:
    ...
    case 1255:
      ...
      END_STATE();
    case 1256:
      if (lookahead == 'k') ADVANCE(3130);
      END_STATE();
    case 1257:
      if (lookahead == 'k') ADVANCE(3131);
      END_STATE();
    case 1258:
      if (lookahead == 'k') ADVANCE(3171);
      END_STATE();
    case 1259:
    ...
    case 1287:
      ...
      END_STATE();
    case 1288:
      if (lookahead == 'l') ADVANCE(3141);
      END_STATE();
    case 1289:
      if (lookahead == 'l') ADVANCE(3293);
      END_STATE();
    case 1290:
      if (lookahead == 'l') ADVANCE(3232);
      END_STATE();
    case 1291:
      if (lookahead == 'l') ADVANCE(3082);
      END_STATE();
    case 1292:
      if (lookahead == 'l') ADVANCE(3222);
      END_STATE();
    case 1293:
      if (lookahead == 'l') ADVANCE(3227);
      END_STATE();
    case 1294:
      if (lookahead == 'l') ADVANCE(3381);
      END_STATE();
    case 1295:
      if (lookahead == 'l') ADVANCE(3379);
      END_STATE();
    case 1296:
      if (lookahead == 'l') ADVANCE(3380);
      END_STATE();
    case 1297:
      if (lookahead == 'l') ADVANCE(3083);
      END_STATE();
    case 1298:
      if (lookahead == 'l') ADVANCE(3382);
      END_STATE();
    case 1299:
      if (lookahead == 'l') ADVANCE(3225);
      END_STATE();
    case 1300:
      if (lookahead == 'l') ADVANCE(3224);
      END_STATE();
    case 1301:
    ...
    case 1387:
      ...
      END_STATE();
    case 1388:
      if (lookahead == 'm') ADVANCE(3250);
      END_STATE();
    case 1389:
      if (lookahead == 'm') ADVANCE(3103);
      END_STATE();
    case 1390:
      if (lookahead == 'm') ADVANCE(3251);
      END_STATE();
    case 1391:
      if (lookahead == 'm') ADVANCE(3165);
      END_STATE();
    case 1392:
      if (lookahead == 'm') ADVANCE(3104);
      END_STATE();
    case 1393:
      if (lookahead == 'm') ADVANCE(3079);
      END_STATE();
    case 1394:
    ...
    case 1444:
      ...
      END_STATE();
    case 1445:
      if (lookahead == 'n') ADVANCE(3269);
      END_STATE();
    case 1446:
      if (lookahead == 'n') ADVANCE(3149);
      END_STATE();
    case 1447:
      if (lookahead == 'n') ADVANCE(3373);
      END_STATE();
    case 1448:
    ...
    case 1449:
      ...
      END_STATE();
    case 1450:
      if (lookahead == 'n') ADVANCE(3378);
      END_STATE();
    case 1451:
      if (lookahead == 'n') ADVANCE(3396);
      END_STATE();
    case 1452:
      if (lookahead == 'n') ADVANCE(3150);
      END_STATE();
    case 1453:
      if (lookahead == 'n') ADVANCE(3122);
      END_STATE();
    case 1454:
      if (lookahead == 'n') ADVANCE(3144);
      END_STATE();
    case 1455:
      if (lookahead == 'n') ADVANCE(3105);
      END_STATE();
    case 1456:
    ...
    case 1566:
      ...
      END_STATE();
    case 1567:
      if (lookahead == 'o') ADVANCE(3258);
      END_STATE();
    case 1568:
      if (lookahead == 'o') ADVANCE(3388);
      END_STATE();
    case 1569:
      if (lookahead == 'o') ADVANCE(3389);
      END_STATE();
    case 1570:
      if (lookahead == 'o') ADVANCE(3405);
      END_STATE();
    case 1571:
    ...
    case 1668:
      ...
      END_STATE();
    case 1669:
      if (lookahead == 'p') ADVANCE(3259);
      END_STATE();
    case 1670:
      if (lookahead == 'p') ADVANCE(3133);
      END_STATE();
    case 1671:
      if (lookahead == 'p') ADVANCE(3261);
      END_STATE();
    case 1672:
    ...
    case 1723:
      ...
      END_STATE();
    case 1724:
      if (lookahead == 'p') ADVANCE(2115);
      END_STATE();
    case 1725:
      if (lookahead == 'p') ADVANCE(2116);
      END_STATE();
    case 1726:
    ...
    case 1732:
      ...
      END_STATE();
    case 1733:
      if (lookahead == 'q') ADVANCE(2277);
      END_STATE();
    case 1734:
      if (lookahead == 'q') ADVANCE(2147);
      END_STATE();
    case 1735:
    ...
    case 1736:
      ...
      END_STATE();
    case 1737:
      if (lookahead == 'r') ADVANCE(3114);
      END_STATE();
    case 1738:
      if (lookahead == 'r') ADVANCE(744);
      END_STATE();
    case 1739:
      if (lookahead == 'r') ADVANCE(3263);
      END_STATE();
    case 1740:
      if (lookahead == 'r') ADVANCE(3115);
      END_STATE();
    case 1741:
      if (lookahead == 'r') ADVANCE(3241);
      END_STATE();
    case 1742:
      if (lookahead == 'r') ADVANCE(3262);
      END_STATE();
    case 1743:
      if (lookahead == 'r') ADVANCE(3097);
      END_STATE();
    case 1744:
    ...
    case 1753:
      ...
      END_STATE();
    case 1754:
      if (lookahead == 'r') ADVANCE(3098);
      END_STATE();
    case 1755:
      if (lookahead == 'r') ADVANCE(2240);
      END_STATE();
    case 1756:
    ...
    case 1900:
      ...
      END_STATE();
    case 1901:
      if (lookahead == 's') ADVANCE(3278);
      END_STATE();
    case 1902:
      if (lookahead == 's') ADVANCE(3272);
      END_STATE();
    case 1903:
    ...
    case 1909:
      ...
      END_STATE();
    case 1910:
      if (lookahead == 's') ADVANCE(3242);
      END_STATE();
    case 1911:
      if (lookahead == 's') ADVANCE(3080);
      END_STATE();
    case 1912:
      if (lookahead == 's') ADVANCE(3159);
      END_STATE();
    case 1913:
      if (lookahead == 's') ADVANCE(3188);
      END_STATE();
    case 1914:
      if (lookahead == 's') ADVANCE(3168);
      END_STATE();
    case 1915:
      if (lookahead == 's') ADVANCE(3112);
      END_STATE();
    case 1916:
    ...
    case 2224:
      ...
      END_STATE();
    case 2225:
      if (lookahead == 'y') ADVANCE(3073);
      END_STATE();
    case 2226:
      if (lookahead == 'y') ADVANCE(3139);
      END_STATE();
    case 2227:
      if (lookahead == 'y') ADVANCE(3189);
      END_STATE();
    case 2228:
      if (lookahead == 'y') ADVANCE(3174);
      END_STATE();
    case 2229:
      if (lookahead == 'y') ADVANCE(3228);
      END_STATE();
    case 2230:
      if (lookahead == 'y') ADVANCE(3186);
      END_STATE();
    case 2231:
      if (lookahead == 'y') ADVANCE(3185);
      END_STATE();
    case 2232:
      if (lookahead == 'y') ADVANCE(3179);
      END_STATE();
    case 2233:
      if (lookahead == 'y') ADVANCE(3151);
      END_STATE();
    case 2234:
      if (lookahead == 'y') ADVANCE(3247);
      END_STATE();
    case 2235:
      if (lookahead == 'y') ADVANCE(3401);
      END_STATE();
    case 2236:
      if (lookahead == 'y') ADVANCE(3184);
      END_STATE();
    case 2237:
      if (lookahead == 'y') ADVANCE(3152);
      END_STATE();
    case 2238:
    ...
    case 2280:
      ...
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2453);
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2477);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3011);
      END_STATE();
    case 2281:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2853);
    ...
    case 2282:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2762);
      END_STATE();
    case 2283:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2333);
      END_STATE();
    case 2284:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2356);
    ...
    case 2287:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2638);
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2839);
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2568);
      END_STATE();
    case 2288:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2638);
    ...
    case 2292:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2647);
      END_STATE();
    case 2293:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2665);
      END_STATE();
    case 2294:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2614);
      END_STATE();
    case 2295:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2615);
      END_STATE();
    case 2296:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2371);
      END_STATE();
    case 2297:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2371);
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2765);
      END_STATE();
    case 2298:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2916);
    ...
    case 2304:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2398);
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2317);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2999);
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2959);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2756);
      if (lookahead == '0' ||
          lookahead == '1' ||
          lookahead == '3') ADVANCE(3286);
      END_STATE();
    case 2305:
      if (lookahead == 'A' ||
    ...
    case 2308:
      ...
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2762);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2679);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2937);
      END_STATE();
    case 2309:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2694);
      END_STATE();
    case 2310:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2902);
      END_STATE();
    case 2311:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2883);
      END_STATE();
    case 2312:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2620);
      END_STATE();
    case 2313:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2512);
    ...
    case 2315:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2918);
      END_STATE();
    case 2316:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2680);
      END_STATE();
    case 2317:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2878);
      END_STATE();
    case 2318:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2358);
      END_STATE();
    case 2319:
      if (lookahead == 'A' ||
    ...
    case 2321:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2685);
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2832);
      END_STATE();
    case 2322:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(3015);
      END_STATE();
    case 2323:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2522);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2852);
      END_STATE();
    case 2324:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2342);
      END_STATE();
    case 2325:
      if (lookahead == 'A' ||
    ...
    case 2327:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2648);
      END_STATE();
    case 2328:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2938);
      END_STATE();
    case 2329:
      if (lookahead == 'A' ||
    ...
    case 2330:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2348);
      END_STATE();
    case 2331:
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(2649);
      END_STATE();
    case 2332:
      if (lookahead == 'B' ||
    ...
    case 2335:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2962);
      END_STATE();
    case 2336:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2947);
      END_STATE();
    case 2337:
      if (lookahead == 'B' ||
    ...
    case 2338:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2792);
      END_STATE();
    case 2339:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2749);
      END_STATE();
    case 2340:
      if (lookahead == 'B' ||
    ...
    case 2341:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2596);
      END_STATE();
    case 2342:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2640);
      END_STATE();
    case 2343:
      if (lookahead == 'B' ||
    ...
    case 2344:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2597);
      END_STATE();
    case 2345:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2636);
      END_STATE();
    case 2346:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2610);
      END_STATE();
    case 2347:
      if (lookahead == 'B' ||
    ...
    case 2348:
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(2645);
      END_STATE();
    case 2349:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2589);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3058);
      END_STATE();
    case 2350:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3361);
      END_STATE();
    case 2351:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3233);
      END_STATE();
    case 2352:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3294);
      END_STATE();
    case 2353:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2807);
    ...
    case 2354:
      ...
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2427);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2869);
      END_STATE();
    case 2355:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3017);
      END_STATE();
    case 2356:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2588);
      END_STATE();
    case 2357:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2899);
      END_STATE();
    case 2358:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2585);
      END_STATE();
    case 2359:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2586);
      END_STATE();
    case 2360:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2703);
      END_STATE();
    case 2361:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2292);
      END_STATE();
    case 2362:
      if (lookahead == 'C' ||
    ...
    case 2363:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2854);
      END_STATE();
    case 2364:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2305);
      if (lookahead == 'O' ||
    ...
    case 2366:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2905);
      END_STATE();
    case 2367:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2479);
      END_STATE();
    case 2368:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2459);
      END_STATE();
    case 2369:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2457);
      END_STATE();
    case 2370:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2600);
      END_STATE();
    case 2371:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2601);
      END_STATE();
    case 2372:
      if (lookahead == 'C' ||
    ...
    case 2375:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(2482);
      END_STATE();
    case 2376:
      if (lookahead == 'C' ||
          lookahead == 'c') ADVANCE(3021);
      END_STATE();
    case 2377:
      if (lookahead == 'C' ||
    ...
    case 2379:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3463);
      END_STATE();
    case 2380:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3493);
      END_STATE();
    case 2381:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3277);
      END_STATE();
    case 2382:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3464);
      END_STATE();
    case 2383:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3237);
      END_STATE();
    case 2384:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3244);
      END_STATE();
    case 2385:
      if (lookahead == 'D' ||
    ...
    case 2386:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3270);
      END_STATE();
    case 2387:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3248);
      END_STATE();
    case 2388:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(3294);
      END_STATE();
    case 2389:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2410);
      END_STATE();
    case 2390:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2856);
      END_STATE();
    case 2391:
      if (lookahead == 'D' ||
    ...
    case 2392:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2863);
      END_STATE();
    case 2393:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2583);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2476);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2967);
      END_STATE();
    case 2394:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2428);
    ...
    case 2397:
      if (lookahead == 'D' ||
          lookahead == 'd') ADVANCE(2302);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2364);
      END_STATE();
    case 2398:
      if (lookahead == 'D' ||
    ...
    case 2405:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2472);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2530);
      END_STATE();
    case 2406:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3489);
      END_STATE();
    case 2407:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3462);
      END_STATE();
    case 2408:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3493);
      END_STATE();
    case 2409:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3490);
      END_STATE();
    case 2410:
      if (lookahead == 'E' ||
    ...
    case 2417:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2771);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(2373);
      END_STATE();
    case 2418:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3361);
      END_STATE();
    case 2419:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3237);
      END_STATE();
    case 2420:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3244);
      END_STATE();
    case 2421:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3270);
      END_STATE();
    case 2422:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3397);
      END_STATE();
    case 2423:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3199);
      END_STATE();
    case 2424:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3294);
      END_STATE();
    case 2425:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3240);
      END_STATE();
    case 2426:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2483);
      END_STATE();
    case 2427:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2357);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(82);
      END_STATE();
    case 2428:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2500);
      END_STATE();
    case 2429:
      if (lookahead == 'E' ||
    ...
    case 2435:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2980);
      END_STATE();
    case 2436:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2696);
      END_STATE();
    case 2437:
      if (lookahead == 'E' ||
    ...
    case 2445:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2884);
      END_STATE();
    case 2446:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3008);
      END_STATE();
    case 2447:
      if (lookahead == 'E' ||
    ...
    case 2453:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2370);
      END_STATE();
    case 2454:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2639);
      if (lookahead == 'H' ||
    ...
    case 2459:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2616);
      END_STATE();
    case 2460:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2902);
      END_STATE();
    case 2461:
      if (lookahead == 'E' ||
    ...
    case 2470:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3012);
      END_STATE();
    case 2471:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2366);
      END_STATE();
    case 2472:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2778);
    ...
    case 2486:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3016);
      END_STATE();
    case 2487:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2846);
      END_STATE();
    case 2488:
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(2849);
      END_STATE();
    case 2489:
      if (lookahead == 'E' ||
    ...
    case 2497:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(2789);
      END_STATE();
    case 2498:
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(2569);
      END_STATE();
    case 2499:
      if (lookahead == 'F' ||
    ...
    case 2502:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3273);
      END_STATE();
    case 2503:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3361);
      END_STATE();
    case 2504:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3289);
      END_STATE();
    case 2505:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3244);
      END_STATE();
    case 2506:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3275);
      END_STATE();
    case 2507:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3199);
      END_STATE();
    case 2508:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(3240);
      END_STATE();
    case 2509:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2535);
      END_STATE();
    case 2510:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2466);
      END_STATE();
    case 2511:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2714);
    ...
    case 2512:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2407);
      END_STATE();
    case 2513:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2879);
      END_STATE();
    case 2514:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2443);
      END_STATE();
    case 2515:
      if (lookahead == 'G' ||
    ...
    case 2516:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2855);
      END_STATE();
    case 2517:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2854);
      END_STATE();
    case 2518:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2767);
      END_STATE();
    case 2519:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2768);
      END_STATE();
    case 2520:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2415);
      END_STATE();
    case 2521:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2863);
      END_STATE();
    case 2522:
      if (lookahead == 'G' ||
          lookahead == 'g') ADVANCE(2423);
      END_STATE();
    case 2523:
      if (lookahead == 'G' ||
    ...
    case 2524:
      ...
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2628);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2536);
      END_STATE();
    case 2525:
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2713);
      END_STATE();
    case 2526:
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2552);
      END_STATE();
    case 2527:
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2418);
      END_STATE();
    case 2528:
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2754);
      END_STATE();
    case 2529:
      if (lookahead == 'H' ||
          lookahead == 'h') ADVANCE(2752);
      if (lookahead == 'O' ||
    ...
    case 2538:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2509);
      END_STATE();
    case 2539:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2381);
      END_STATE();
    case 2540:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2690);
      END_STATE();
    case 2541:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2335);
      END_STATE();
    case 2542:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2513);
      END_STATE();
    case 2543:
      if (lookahead == 'I' ||
    ...
    case 2544:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2912);
      END_STATE();
    case 2545:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2399);
      END_STATE();
    case 2546:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2831);
      END_STATE();
    case 2547:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2390);
      END_STATE();
    case 2548:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2506);
      END_STATE();
    case 2549:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2385);
      END_STATE();
    case 2550:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2523);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2404);
      END_STATE();
    case 2551:
      if (lookahead == 'I' ||
    ...
    case 2562:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2809);
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2806);
      END_STATE();
    case 2563:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2517);
      END_STATE();
    case 2564:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2396);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2968);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2320);
      END_STATE();
    case 2565:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2723);
      END_STATE();
    case 2566:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2979);
      END_STATE();
    case 2567:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2656);
      END_STATE();
    case 2568:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2514);
      END_STATE();
    case 2569:
      if (lookahead == 'I' ||
    ...
    case 2570:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2516);
      END_STATE();
    case 2571:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2402);
      END_STATE();
    case 2572:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2392);
      END_STATE();
    case 2573:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2521);
      END_STATE();
    case 2574:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2521);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2347);
      END_STATE();
    case 2575:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2744);
      END_STATE();
    case 2576:
      if (lookahead == 'I' ||
    ...
    case 2580:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2935);
      END_STATE();
    case 2581:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2400);
      END_STATE();
    case 2582:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2376);
      END_STATE();
    case 2583:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2893);
      END_STATE();
    case 2584:
      if (lookahead == 'I' ||
          lookahead == 'i') ADVANCE(2403);
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2969);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2323);
      END_STATE();
    case 2585:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(3395);
      END_STATE();
    case 2586:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(3361);
      END_STATE();
    case 2587:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(3248);
      END_STATE();
    case 2588:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2946);
      END_STATE();
    case 2589:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2946);
    ...
    case 2592:
      ...
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2524);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2910);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2564);
      END_STATE();
    case 2593:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2383);
      END_STATE();
    case 2594:
      if (lookahead == 'K' ||
    ...
    case 2595:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2386);
      END_STATE();
    case 2596:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2433);
      END_STATE();
    case 2597:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2478);
      END_STATE();
    case 2598:
      if (lookahead == 'K' ||
    ...
    case 2599:
      ...
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2681);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2529);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2550);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2584);
      END_STATE();
    case 2600:
      if (lookahead == 'K' ||
    ...
    case 2601:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2460);
      END_STATE();
    case 2602:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2896);
      END_STATE();
    case 2603:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2470);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2602);
      END_STATE();
    case 2604:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2465);
      END_STATE();
    case 2605:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2683);
      END_STATE();
    case 2606:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2475);
      END_STATE();
    case 2607:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2953);
      END_STATE();
    case 2608:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2953);
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2343);
      END_STATE();
    case 2609:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2691);
      END_STATE();
    case 2610:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2481);
      END_STATE();
    case 2611:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2486);
      END_STATE();
    case 2612:
      if (lookahead == 'K' ||
          lookahead == 'k') ADVANCE(2492);
      END_STATE();
    case 2613:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3462);
      END_STATE();
    case 2614:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3279);
      END_STATE();
    case 2615:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3273);
      END_STATE();
    case 2616:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3395);
      END_STATE();
    case 2617:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3237);
      END_STATE();
    case 2618:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3244);
      END_STATE();
    case 2619:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3270);
      END_STATE();
    case 2620:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3397);
      END_STATE();
    case 2621:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2594);
      END_STATE();
    case 2622:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3003);
      END_STATE();
    case 2623:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2988);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2924);
      END_STATE();
    case 2624:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3005);
      END_STATE();
    case 2625:
      if (lookahead == 'L' ||
    ...
    case 2628:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2543);
      END_STATE();
    case 2629:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2856);
      END_STATE();
    case 2630:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2545);
      END_STATE();
    case 2631:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2903);
      END_STATE();
    case 2632:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2311);
      END_STATE();
    case 2633:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2901);
      END_STATE();
    case 2634:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2863);
      END_STATE();
    case 2635:
      if (lookahead == 'L' ||
    ...
    case 2636:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2451);
      END_STATE();
    case 2637:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2421);
      END_STATE();
    case 2638:
      if (lookahead == 'L' ||
    ...
    case 2639:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2496);
      END_STATE();
    case 2640:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2474);
      END_STATE();
    case 2641:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2444);
      END_STATE();
    case 2642:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2927);
      END_STATE();
    case 2643:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2449);
      END_STATE();
    case 2644:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(3020);
      END_STATE();
    case 2645:
      if (lookahead == 'L' ||
    ...
    case 2650:
      if (lookahead == 'L' ||
          lookahead == 'l') ADVANCE(2582);
      END_STATE();
    case 2651:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2730);
      END_STATE();
    case 2652:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2730);
    ...
    case 2653:
      ...
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2350);
      END_STATE();
    case 2654:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2788);
      END_STATE();
    case 2655:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2294);
      END_STATE();
    case 2656:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2295);
      END_STATE();
    case 2657:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2751);
      END_STATE();
    case 2658:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2462);
      END_STATE();
    case 2659:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2779);
      END_STATE();
    case 2660:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2301);
      END_STATE();
    case 2661:
      if (lookahead == 'M' ||
          lookahead == 'm') ADVANCE(2340);
      END_STATE();
    case 2662:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2360);
    ...
    case 2663:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3462);
      END_STATE();
    case 2664:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3279);
      END_STATE();
    case 2665:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3273);
      END_STATE();
    case 2666:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3270);
      END_STATE();
    case 2667:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(3248);
      END_STATE();
    case 2668:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2406);
    ...
    case 2669:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2622);
      END_STATE();
    case 2670:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2605);
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2619);
      END_STATE();
    case 2671:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2503);
      END_STATE();
    case 2672:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2724);
    ...
    case 2678:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2775);
      END_STATE();
    case 2679:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2750);
      END_STATE();
    case 2680:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2412);
      END_STATE();
    case 2681:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2644);
      END_STATE();
    case 2682:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2863);
      END_STATE();
    case 2683:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2722);
      END_STATE();
    case 2684:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2419);
      END_STATE();
    case 2685:
      if (lookahead == 'N' ||
    ...
    case 2686:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2411);
      END_STATE();
    case 2687:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2409);
      END_STATE();
    case 2688:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2424);
      END_STATE();
    case 2689:
      if (lookahead == 'N' ||
    ...
    case 2690:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2560);
      END_STATE();
    case 2691:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2743);
      END_STATE();
    case 2692:
      if (lookahead == 'N' ||
    ...
    case 2695:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2609);
      END_STATE();
    case 2696:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2895);
      END_STATE();
    case 2697:
      if (lookahead == 'N' ||
          lookahead == 'n') ADVANCE(2760);
    ...
    case 2703:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2654);
      END_STATE();
    case 2704:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2394);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2391);
      END_STATE();
    case 2705:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(3361);
      END_STATE();
    case 2706:
      if (lookahead == 'O' ||
    ...
    case 2707:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(3248);
      END_STATE();
    case 2708:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2991);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2539);
      END_STATE();
    case 2709:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2991);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2549);
      END_STATE();
    case 2710:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2591);
      END_STATE();
    case 2711:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2669);
    ...
    case 2716:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2361);
      END_STATE();
    case 2717:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2994);
      END_STATE();
    case 2718:
      if (lookahead == 'O' ||
    ...
    case 2723:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2676);
      END_STATE();
    case 2724:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2934);
      END_STATE();
    case 2725:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2815);
      END_STATE();
    case 2726:
      if (lookahead == 'O' ||
    ...
    case 2727:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2856);
      END_STATE();
    case 2728:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2387);
      END_STATE();
    case 2729:
      if (lookahead == 'O' ||
    ...
    case 2734:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2728);
      END_STATE();
    case 2735:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2989);
      END_STATE();
    case 2736:
      if (lookahead == 'O' ||
    ...
    case 2741:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2841);
      END_STATE();
    case 2742:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2958);
      END_STATE();
    case 2743:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2987);
      END_STATE();
    case 2744:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2682);
      END_STATE();
    case 2745:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2990);
    ...
    case 2749:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2880);
      END_STATE();
    case 2750:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2837);
      END_STATE();
    case 2751:
      if (lookahead == 'O' ||
    ...
    case 2753:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2686);
      END_STATE();
    case 2754:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2829);
      END_STATE();
    case 2755:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2687);
      END_STATE();
    case 2756:
      if (lookahead == 'O' ||
    ...
    case 2758:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2689);
      END_STATE();
    case 2759:
      if (lookahead == 'O' ||
          lookahead == 'o') ADVANCE(2377);
      END_STATE();
    case 2760:
      if (lookahead == 'O' ||
    ...
    case 2763:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3279);
      END_STATE();
    case 2764:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3361);
      END_STATE();
    case 2765:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3026);
      END_STATE();
    case 2766:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3238);
      END_STATE();
    case 2767:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3289);
      END_STATE();
    case 2768:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(3233);
      END_STATE();
    case 2769:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2796);
    ...
    case 2775:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2518);
      END_STATE();
    case 2776:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2577);
      END_STATE();
    case 2777:
      if (lookahead == 'P' ||
    ...
    case 2779:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2725);
      END_STATE();
    case 2780:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2452);
      END_STATE();
    case 2781:
      if (lookahead == 'P' ||
    ...
    case 2782:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2720);
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2785);
      END_STATE();
    case 2783:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2519);
    ...
    case 2785:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2824);
      END_STATE();
    case 2786:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2921);
      END_STATE();
    case 2787:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2825);
      END_STATE();
    case 2788:
      if (lookahead == 'P' ||
    ...
    case 2789:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2838);
      END_STATE();
    case 2790:
      if (lookahead == 'P' ||
          lookahead == 'p') ADVANCE(2833);
      END_STATE();
    case 2791:
      if (lookahead == 'P' ||
    ...
    case 2796:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3462);
      END_STATE();
    case 2797:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3231);
      END_STATE();
    case 2798:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3218);
      END_STATE();
    case 2799:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3395);
      END_STATE();
    case 2800:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3361);
      END_STATE();
    case 2801:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3237);
      END_STATE();
    case 2802:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(3397);
      END_STATE();
    case 2803:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2538);
    ...
    case 2809:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2432);
      END_STATE();
    case 2810:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2413);
      END_STATE();
    case 2811:
      if (lookahead == 'R' ||
    ...
    case 2812:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2629);
      END_STATE();
    case 2813:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2445);
      END_STATE();
    case 2814:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2943);
      END_STATE();
    case 2815:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2900);
      END_STATE();
    case 2816:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2820);
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2782);
      END_STATE();
    case 2817:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2541);
      END_STATE();
    case 2818:
      if (lookahead == 'R' ||
    ...
    case 2819:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2903);
      END_STATE();
    case 2820:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2729);
      END_STATE();
    case 2821:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2618);
      END_STATE();
    case 2822:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2450);
      END_STATE();
    case 2823:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2904);
      END_STATE();
    case 2824:
      if (lookahead == 'R' ||
    ...
    case 2828:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2554);
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2491);
      END_STATE();
    case 2829:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2907);
      END_STATE();
    case 2830:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2719);
      END_STATE();
    case 2831:
      if (lookahead == 'R' ||
    ...
    case 2845:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2931);
      END_STATE();
    case 2846:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2977);
      END_STATE();
    case 2847:
      if (lookahead == 'R' ||
    ...
    case 2850:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2981);
      END_STATE();
    case 2851:
      if (lookahead == 'R' ||
          lookahead == 'r') ADVANCE(2983);
      END_STATE();
    case 2852:
      if (lookahead == 'R' ||
    ...
    case 2853:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2933);
      END_STATE();
    case 2854:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3279);
      END_STATE();
    case 2855:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3273);
      END_STATE();
    case 2856:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3201);
      END_STATE();
    case 2857:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3464);
      END_STATE();
    case 2858:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3237);
      END_STATE();
    case 2859:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3289);
      END_STATE();
    case 2860:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3244);
      END_STATE();
    case 2861:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3271);
      END_STATE();
    case 2862:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3233);
      END_STATE();
    case 2863:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(3199);
      END_STATE();
    case 2864:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2574);
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2572);
      END_STATE();
    case 2865:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2913);
    ...
    case 2867:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2526);
      END_STATE();
    case 2868:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2283);
      END_STATE();
    case 2869:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2544);
    ...
    case 2884:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2876);
      END_STATE();
    case 2885:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2542);
      END_STATE();
    case 2886:
      if (lookahead == 'S' ||
    ...
    case 2887:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2570);
      END_STATE();
    case 2888:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2548);
      END_STATE();
    case 2889:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2573);
      END_STATE();
    case 2890:
      if (lookahead == 'S' ||
    ...
    case 2891:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2487);
      END_STATE();
    case 2892:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2966);
      END_STATE();
    case 2893:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2329);
      END_STATE();
    case 2894:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2330);
      END_STATE();
    case 2895:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2580);
      END_STATE();
    case 2896:
      if (lookahead == 'S' ||
    ...
    case 2897:
      if (lookahead == 'S' ||
          lookahead == 's') ADVANCE(2489);
      END_STATE();
    case 2898:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3462);
      END_STATE();
    case 2899:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3192);
      END_STATE();
    case 2900:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3273);
      END_STATE();
    case 2901:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3395);
      END_STATE();
    case 2902:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3361);
      END_STATE();
    case 2903:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3237);
      END_STATE();
    case 2904:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3244);
      END_STATE();
    case 2905:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3233);
      END_STATE();
    case 2906:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3294);
      END_STATE();
    case 2907:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3240);
      END_STATE();
    case 2908:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2796);
      END_STATE();
    case 2909:
      if (lookahead == 'T' ||
    ...
    case 2911:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3005);
      END_STATE();
    case 2912:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2532);
      END_STATE();
    case 2913:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2746);
      END_STATE();
    case 2914:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(3009);
      END_STATE();
    case 2915:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2785);
    ...
    case 2920:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2440);
      END_STATE();
    case 2921:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2705);
      END_STATE();
    case 2922:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2863);
      END_STATE();
    case 2923:
      if (lookahead == 'T' ||
    ...
    case 2924:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2706);
      END_STATE();
    case 2925:
      if (lookahead == 'T' ||
          lookahead == 't') ADVANCE(2732);
      END_STATE();
    case 2926:
      if (lookahead == 'T' ||
    ...
    case 2942:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(3234);
      END_STATE();
    case 2943:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(3294);
      END_STATE();
    case 2944:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2341);
      END_STATE();
    case 2945:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2493);
      END_STATE();
    case 2946:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2763);
      END_STATE();
    case 2947:
      if (lookahead == 'U' ||
    ...
    case 2950:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2338);
      END_STATE();
    case 2951:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2774);
      END_STATE();
    case 2952:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2812);
      END_STATE();
    case 2953:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2764);
      END_STATE();
    case 2954:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2571);
      END_STATE();
    case 2955:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2633);
      END_STATE();
    case 2956:
      if (lookahead == 'U' ||
    ...
    case 2957:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2821);
      END_STATE();
    case 2958:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2904);
      END_STATE();
    case 2959:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2814);
      END_STATE();
    case 2960:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2401);
      END_STATE();
    case 2961:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2873);
      END_STATE();
    case 2962:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2923);
      END_STATE();
    case 2963:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2843);
      END_STATE();
    case 2964:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2631);
      END_STATE();
    case 2965:
      if (lookahead == 'U' ||
    ...
    case 2967:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2346);
      END_STATE();
    case 2968:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2890);
      END_STATE();
    case 2969:
      if (lookahead == 'U' ||
          lookahead == 'u') ADVANCE(2894);
      END_STATE();
    case 2970:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2710);
    ...
    case 2971:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2314);
      END_STATE();
    case 2972:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2429);
      END_STATE();
    case 2973:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2721);
      END_STATE();
    case 2974:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2859);
      END_STATE();
    case 2975:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2480);
      END_STATE();
    case 2976:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2309);
      END_STATE();
    case 2977:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2458);
      END_STATE();
    case 2978:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2757);
      END_STATE();
    case 2979:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2467);
      END_STATE();
    case 2980:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2606);
      END_STATE();
    case 2981:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2484);
      END_STATE();
    case 2982:
      if (lookahead == 'V' ||
    ...
    case 2983:
      if (lookahead == 'V' ||
          lookahead == 'v') ADVANCE(2488);
      END_STATE();
    case 2984:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(3273);
      END_STATE();
    case 2985:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2666);
      END_STATE();
    case 2986:
      if (lookahead == 'W' ||
    ...
    case 2987:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2667);
      END_STATE();
    case 2988:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2322);
      END_STATE();
    case 2989:
      if (lookahead == 'W' ||
    ...
    case 2991:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2677);
      END_STATE();
    case 2992:
      if (lookahead == 'W' ||
          lookahead == 'w') ADVANCE(2881);
      END_STATE();
    case 2993:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(3462);
      END_STATE();
    case 2994:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(3199);
      END_STATE();
    case 2995:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2646);
      END_STATE();
    case 2996:
      if (lookahead == 'X' ||
    ...
    case 2999:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2794);
      END_STATE();
    case 3000:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(2793);
      END_STATE();
    case 3001:
      if (lookahead == 'X' ||
          lookahead == 'x') ADVANCE(3053);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3059);
      END_STATE();
    ...
    case 3003:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(3273);
      END_STATE();
    case 3004:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(3277);
      END_STATE();
    case 3005:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(3201);
      END_STATE();
    case 3006:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(3361);
      END_STATE();
    case 3007:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(3244);
      END_STATE();
    case 3008:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2828);
      END_STATE();
    case 3009:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(3199);
      END_STATE();
    case 3010:
      if (lookahead == 'Y' ||
    ...
    case 3011:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2786);
      END_STATE();
    case 3012:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2855);
      END_STATE();
    case 3013:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2854);
      END_STATE();
    case 3014:
      if (lookahead == 'Y' ||
    ...
    case 3015:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2862);
      END_STATE();
    case 3016:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2863);
      END_STATE();
    case 3017:
      if (lookahead == 'Y' ||
    ...
    case 3022:
      if (lookahead == 'Y' ||
          lookahead == 'y') ADVANCE(2897);
      END_STATE();
    case 3023:
      if (lookahead == 'Z' ||
          lookahead == 'z') ADVANCE(2407);
      END_STATE();
    case 3024:
      if (lookahead == 'e' ||
          lookahead == 't') ADVANCE(3466);
      END_STATE();
    case 3025:
      if (lookahead == '-' ||
          lookahead == 'c' ||
          lookahead == 't') ADVANCE(3470);
      END_STATE();
    case 3026:
      if (('6' <= lookahead && lookahead <= '8')) ADVANCE(3289);
      END_STATE();
    case 3027:
      if (lookahead == 'd' ||
          lookahead == 'm' ||
    ...
    case 3031:
      if (lookahead == 'f' ||
          lookahead == 'n' ||
          lookahead == 't' ||
          lookahead == 'z') ADVANCE(3469);
      if (lookahead == 'g') ADVANCE(3024);
      if (lookahead == 'l') ADVANCE(3024);
      END_STATE();
    case 3032:
      if (('0' <= lookahead && lookahead <= '3')) ADVANCE(3226);
      END_STATE();
    case 3033:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(36);
      if (('A' <= lookahead && lookahead <= 'Z') ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(3443);
      END_STATE();
    case 3034:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3444);
      END_STATE();
    case 3035:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3457);
      END_STATE();
    case 3036:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3458);
      END_STATE();
    case 3037:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(408);
      END_STATE();
    case 3038:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3037);
      END_STATE();
    case 3039:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3035);
      END_STATE();
    case 3040:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3042);
      END_STATE();
    case 3041:
    ...
    case 3046:
      ...
      END_STATE();
    case 3047:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3044);
      END_STATE();
    case 3048:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3045);
      END_STATE();
    case 3049:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3046);
      END_STATE();
    case 3050:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3047);
      END_STATE();
    case 3051:
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3048);
      END_STATE();
    case 3052:
    ...
    case 3054:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3442);
      END_STATE();
    case 3055:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
    ...
    case 3061:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3360);
      END_STATE();
    case 3062:
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
    ...
    case 3063:
      if (lookahead == '+' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(3406);
      END_STATE();
    case 3064:
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != ' ' &&
          lookahead != '=') ADVANCE(3260);
      END_STATE();
    case 3065:
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(3471);
    ...
    case 3066:
      ...
      if (lookahead == 'F') ADVANCE(2769);
      if (lookahead == 'H') ADVANCE(2590);
      if (lookahead == 'I') ADVANCE(339);
      if (lookahead == 'K') ADVANCE(2405);
      if (lookahead == 'L') ADVANCE(2281);
      if (lookahead == 'M') ADVANCE(2334);
      if (lookahead == 'N') ADVANCE(2698);
      if (lookahead == 'O') ADVANCE(2803);
    ...
    case 3204:
      ACCEPT_TOKEN(aux_sym__command_token1);
      if (aux_sym__command_format_token1_character_set_1(lookahead)) ADVANCE(3212);
      END_STATE();
    case 3205:
    ...
    case 3297:
      ...
      if (lookahead == 'g') ADVANCE(3361);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3354);
      END_STATE();
    case 3298:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'H') ADVANCE(3351);
      if (lookahead == 'h') ADVANCE(2418);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3357);
      END_STATE();
    case 3299:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'H') ADVANCE(3301);
      if (lookahead == 'h') ADVANCE(2552);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3357);
      END_STATE();
    case 3300:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'I') ADVANCE(3306);
      if (lookahead == 'i') ADVANCE(2642);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3359);
      END_STATE();
    case 3301:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'I') ADVANCE(3309);
      if (lookahead == 'i') ADVANCE(2671);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3356);
      END_STATE();
    case 3302:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'I') ADVANCE(3358);
      if (lookahead == 'i') ADVANCE(3361);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3358);
      END_STATE();
    case 3303:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'K') ADVANCE(3350);
      if (lookahead == 'k') ADVANCE(2460);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3357);
      END_STATE();
    case 3304:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'K') ADVANCE(3336);
    ...
    case 3305:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'K') ADVANCE(3356);
      if (lookahead == 'k') ADVANCE(3361);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3356);
      END_STATE();
    case 3306:
      ...
      if (lookahead == 'l') ADVANCE(2927);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3358);
      END_STATE();
    case 3307:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'L') ADVANCE(3316);
      if (lookahead == 'R') ADVANCE(3339);
      if (lookahead == 'l') ADVANCE(2738);
      if (lookahead == 'r') ADVANCE(3011);
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(3345);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'f')) ADVANCE(3359);
      END_STATE();
    case 3308:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'M') ADVANCE(3314);
      if (lookahead == 'm') ADVANCE(2730);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3358);
      END_STATE();
    case 3309:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'N') ADVANCE(3297);
      if (lookahead == 'n') ADVANCE(2503);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3355);
      END_STATE();
    case 3310:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'O') ADVANCE(3344);
      if (lookahead == 'P') ADVANCE(3348);
    ...
    case 3314:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'O') ADVANCE(3322);
      if (lookahead == 'S') ADVANCE(3329);
    ...
    case 3317:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'P') ADVANCE(3302);
      if (lookahead == 'p') ADVANCE(2533);
      if (lookahead == 'E' ||
          lookahead == 'e') ADVANCE(3308);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3359);
      END_STATE();
    case 3318:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'P') ADVANCE(3323);
    ...
    case 3320:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'P') ADVANCE(3355);
      if (lookahead == 'p') ADVANCE(3361);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3355);
      END_STATE();
    case 3321:
    ...
    case 3324:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'R') ADVANCE(3355);
      if (lookahead == 'r') ADVANCE(3361);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3355);
      END_STATE();
    case 3325:
    ...
    case 3336:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'U') ADVANCE(3320);
      if (lookahead == 'u') ADVANCE(2764);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3356);
      END_STATE();
    case 3337:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'X') ADVANCE(3328);
      if (lookahead == 'x') ADVANCE(2915);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3359);
      END_STATE();
    case 3338:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'X') ADVANCE(3353);
      if (lookahead == 'x') ADVANCE(3061);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3359);
      END_STATE();
    case 3339:
    ...
    case 3343:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'A' ||
          lookahead == 'a') ADVANCE(3327);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'f')) ADVANCE(3355);
      END_STATE();
    case 3344:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'B' ||
          lookahead == 'b') ADVANCE(3334);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'f')) ADVANCE(3358);
      END_STATE();
    case 3345:
    ...
    case 3352:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (lookahead == 'F' ||
          lookahead == 'f') ADVANCE(3356);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'e')) ADVANCE(3356);
      END_STATE();
    case 3353:
      ACCEPT_TOKEN(aux_sym__debug_token1);
      if (('0' <= lookahead && lookahead <= '9') ||
    ...
    case 3432:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3431);
      END_STATE();
    case 3433:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3432);
      END_STATE();
    case 3434:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3433);
      END_STATE();
    case 3435:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3434);
      END_STATE();
    case 3436:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3435);
      END_STATE();
    case 3437:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3436);
      END_STATE();
    case 3438:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3437);
      END_STATE();
    case 3439:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3438);
      END_STATE();
    case 3440:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3439);
      END_STATE();
    case 3441:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3440);
      END_STATE();
    case 3442:
      ACCEPT_TOKEN(sym_key);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'f')) ADVANCE(3441);
      END_STATE();
    case 3443:
    ...
    case 3445:
      ...
      if (lookahead == 'T') ADVANCE(3052);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3455);
      END_STATE();
    case 3446:
      ACCEPT_TOKEN(sym_number);
    ...
    case 3447:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3447);
      if (lookahead != 0 &&
          (lookahead < '\t' || '\r' < lookahead) &&
          lookahead != ' ') ADVANCE(3460);
      END_STATE();
    case 3448:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3051);
      END_STATE();
    case 3449:
      ACCEPT_TOKEN(sym_number);
    ...
    case 3450:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3449);
      END_STATE();
    case 3451:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3450);
      END_STATE();
    case 3452:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3451);
      END_STATE();
    case 3453:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3452);
      END_STATE();
    case 3454:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3453);
      END_STATE();
    case 3455:
      ACCEPT_TOKEN(sym_number);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(3455);
